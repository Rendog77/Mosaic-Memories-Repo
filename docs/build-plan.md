...
**Status:** In progress. Native selected-photo presentation, atomic private caching, thumbnail review, source sufficiency, and lifecycle cleanup for replaced heroes, rejected source batches, and persisted source removal are implemented. Interactive picker, crop, format, iCloud progress, cancellation, and missing-asset validation remain pending.
